...
//Create out 'main' state that will cotnain the game
...
var mainState = {
  ...
  create: function () {
   ...
   //This is where we'll seet up the game assets from scratch
   ...
   //Creates 20 pipes to hold in the group
  ...
  jump: function() {
    //Let's add vertical velocity to the bird when the spacbar is pressed down
